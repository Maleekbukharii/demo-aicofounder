    ...
    <header className="relative z-50">
      <nav className="fixed top-0 left-0 w-full text-foreground z-50 transition-all duration-300 bg-transparent">
        <div className="max-w-[96rem] w-full mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center text-sm">
          {/* Logo */}
          <Link href="/" aria-label="aicofounder.com home" className="flex items-center">
            <Image
              src="/logo.png"
          ...
          <div className="flex justify-end items-center gap-4">
            ...
            <div className="ml-2 flex items-center gap-2">
              <Link
                href="/signin"
                className="hidden lg:flex px-4 py-1.5 lg:py-2 items-center gap-2 font-medium bg-white hover:bg-gray-50 border border-border rounded-md transition duration-200 ease-in-out"
              >
                Sign in
              </Link>
              <Link
